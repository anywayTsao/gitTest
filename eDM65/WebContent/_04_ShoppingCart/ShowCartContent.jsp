     ...
     <TABLE border='1'>
        <TR >
          <TD width="260" align='center'>
              <!-- <A href="../_03_listBooks/DisplayPageProducts?pageNo=1">繼續購物</A>   -->
              <A href="<c:url value='../_03_listBooks/DisplayPageProducts?pageNo=1' />">繼續購物</A>
          </TD>
          <TD width="260" align='center'>
              <!-- <A href="checkout.do" onClick="return Checkout(${subtotal});">結帳</A>  -->
              <A href="<c:url value='checkout.do' />" onClick="return Checkout(${subtotal});">再次確認</A>
          </TD>
         <TD width="260" align='center'>
              <!-- <A href="abort.do" onClick="return Abort();">放棄購物</A>  -->
